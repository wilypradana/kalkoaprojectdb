...
<body>
  <nav class="relative px-4 py-4 flex justify-between items-center">
		...
		<div class="lg:hidden">
		<button class="navbar-burger flex ml-auto items-center text-blue-600 p-3">
	...
	<div class="navbar-menu relative z-50 hidden">
        ...
        <li class="mb-1">
					...
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Template ppt</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Template cv</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Template Poster</a>
					</li>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Template wordpress</a>
					</li>
				</ul>
			</div>
			<div class="mt-auto">
  ...
  <div
    ...
    <?php endforeach; ?>
     ...
     <!-- akhir template cv -->
 <!-- awal template cv -->
 <h1 class="md:px-8 px-2 mb-4 text-3xl font-bold text-black mt-12">Priview template poster</h1>
    <!-- This is an example component -->
    <section class="flex flex-row flex-wrap mx-auto">
