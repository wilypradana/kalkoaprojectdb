...
$cvs = querycv("SELECT * FROM template_cv WHERE id = $id")[0];
...
>
  ...
  <div class="mx-auto w-1/2 max-w-lg">
    <h1 class="text-4xl font-medium text-center text-white">EDIT CV</h1>
    <form action="" class="mt-10" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id"  value="<?= $cvs["id"]; ?>">
        <input type="hidden" name="gambarLama"  value="<?= $cvs["gambar"]; ?>">
      <input type="hidden"/>
      <div class="grid gap-6 sm:grid-cols-2">
        <div class="relative z-0">
          <input type="text" name="url" class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " autocomplete="off" value="<?= $cvs["link"]; ?>" />
        ...
        <div class="relative z-0 col-span-2">
          ...
          <div class="card w-1/2">
              <img src="../../../../assets/cv/<?=  $cvs["image"] ?>" class="card-img-top" alt="...">
            </div>
      ...
      <button type="submit" name="submit" class="mt-5 rounded-md bg-black px-10 py-2 text-white">edit</button>
    </form>
  </div>
</div>
</div>
